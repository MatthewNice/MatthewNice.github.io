...
# Notes on My Panda Data Collection
...
## Standard Row of Data from Panda/Giraffe Collected
...
Follow the components of the line from left to right. Wheel speed, front right. Start at bit 7, 16 bits long, big-endian, unsigned, scale 0.01, offset -67.67, min value 0, maximum value 250, units kph. We can now take the bits from 7 to 16 in the data, and transform them from hexadecimal to a value that is the speed of the front right wheel.
...
Eight key parts of a CAN message:
	...
	Message Length: length of data in bytes
	Data: Signals
